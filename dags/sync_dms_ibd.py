...
Original file is located at
    https://colab.research.google.com/drive/1Hlv0-7lIczgrQn5eeKz5ofD4Lv3vYdK4
"""
...
def insert():
    dmssql = \
    f"""
    select CONCAT(BranchID,BatNbr,OrderNbr) as pk from {from_tb} where cast (Crtd_DateTime as date ) >= '{date_ms15}'
    """
