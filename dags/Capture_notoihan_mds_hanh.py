...
name='Capture_notoihan_mds_hanh'
prefix='Debt_'
csv_path = '/usr/local/airflow/plugins'+'/'

capture_sql = \
"""
SELECT slsperid,slspername,tenquanlytt,tenquanlyvung,tenquanlykhuvuc, terms,no_toi_han, sum(tiennocongty) as tiennocongty,updated_at from (
	...
	GROUP BY 
slsperid,slspername,tenquanlytt,tenquanlyvung,tenquanlykhuvuc, terms,updated_at,no_toi_han
ORDER BY updated_at
"""
...
def update_table():
	...
	bq_values_insert(df, "f_daily_capture_notoihan_taixe_hanh", 2)
	pk = ['slsperid','updated_at','terms','no_toi_han']
	execute_values_upsert(df, "f_daily_capture_notoihan_taixe_hanh",pk)
