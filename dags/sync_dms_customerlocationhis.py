# -*- coding: utf-8 -*-
"""sync_dms_customerlocationhis.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Inf5zS5D9Ickh0tKjnPBadrDpHGe5dFO
"""
...
from_tb = "AR_CustomerLocationHis"
# from_tb2 = "OM_DeliReportDet"
table_name = "sync_dms_customerlocationhis"
table_temp = "sync_dms_customerlocationhis_temp"
...
# f"""
# SELECT
# REPLACE(CONCAT(BranchID, CustID,CONVERT(varchar, VisitDate, 12),CONVERT(varchar, VisitDate, 24)),':','') as pk,
# BranchID,
# CustID,
# VisitDate,
# OldLat,
...
def insert():
    dmssql = \
    f"""
    select REPLACE(CONCAT(BranchID, CustID,CONVERT(varchar, VisitDate, 12),CONVERT(varchar, VisitDate, 24)),':','') as pk from {from_tb} where cast (Crtd_DateTime as date ) >= '{date_ms45}'
    """
